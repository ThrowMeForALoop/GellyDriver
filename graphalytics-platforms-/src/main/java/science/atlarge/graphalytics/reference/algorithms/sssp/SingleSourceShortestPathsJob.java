...
/**
 * Single Source Shortest Paths job implementation for Reference. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Unspecified
 */
public final class SingleSourceShortestPathsJob extends ReferenceJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										ReferenceConfiguration platformConfig,
