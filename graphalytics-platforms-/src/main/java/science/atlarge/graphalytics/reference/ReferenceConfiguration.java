...
public final class ReferenceConfiguration {
	...
	private static final String HOME_PATH_KEY = "platform.reference.home";
	private static final String NUM_MACHINES_KEY = "platform.reference.num-machines";
	private static final String NUM_THREADS_KEY = "platform.reference.num-threads";
	...
	/**
	 * Creates a new ReferenceConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	...
	public static ReferenceConfiguration parsePropertiesFile() {

		ReferenceConfiguration platformConfig = new ReferenceConfiguration();
