...
/**
 * Community Detection job implementation for Reference. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Unspecified
 */
public final class CommunityDetectionLPJob extends ReferenceJob {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, ReferenceConfiguration platformConfig,
