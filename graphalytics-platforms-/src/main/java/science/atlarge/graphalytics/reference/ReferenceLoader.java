...
public class ReferenceLoader {
	...
	protected ReferenceConfiguration platformConfig;


	/**
	 *	Graph loader for Reference.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public ReferenceLoader(FormattedGraph formattedGraph, ReferenceConfiguration platformConfig) {
