...
/**
 * Page Rank job implementation for Reference. This class is responsible for formatting PR-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Unspecified
 */
public final class PageRankJob extends ReferenceJob {
	 ...
	 */
	public PageRankJob(RunSpecification runSpecification, ReferenceConfiguration platformConfig,
